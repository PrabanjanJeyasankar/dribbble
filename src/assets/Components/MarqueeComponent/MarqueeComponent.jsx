          ...
          {marqueeDatas.map((marqueeData) => (
            ...
            >
              <img
                ...
                src={marqueeData.imageUrl}
              ></img>
              <div className='marquee-persona-info'>
                <p className='marquee-name'>{marqueeData.name}</p>
                <p className='marquee-prof'>{marqueeData.profession}</p>
                <div className='skill-sets'>
                  <p>{marqueeData.skillOne}</p>
                  <p>{marqueeData.skillTwo}</p>
                  <p>{marqueeData.skillThree}</p>
                </div>
              </div>
            </div>
          ))}
